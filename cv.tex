...
\jobentry
	...
	{L3Harris} % Employer
	{Software Engineer and Vulnerability Research Intern} % Job title
...
\qualificationentry
	...
	{
		\begin{itemize}[noitemsep, topsep=0pt, partopsep=0pt, leftmargin=8pt, before =\leavevmode\vspace*{-\baselineskip}]
			\item Object-Oriented Programming (97\%): imperative and object oriented programming in Java including software architecture and unit testing.
			\item Computer Systems (93\%): processor architecture, MIPS Assembly, low-level programming in C. 
...
\extracurricularentry
	...
	{President}
	{
		...
		Led a large committee with several sub working groups: managed budget (>£30,000), liaised with sponsors, organized events.
...
{
		Play CTF as part of Organizers, the number 1 team in 2022. Played in over 10 high-ranking CTFs in the 2022 season.
}
